...
SECRET_KEY = 'django-insecure-rzhp6)p)&4qt8fxg-^(9at4((s^=-w$zqvcffz^8%m*z7lk6uy'
...
MIDDLEWARE = [
    ...
    # 'main.middleware.TokenAuthenticationMiddleware',
]
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,'energeticos_app/resources')
]
