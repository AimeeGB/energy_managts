...
const InstitutoGraph = () => {
    ...
    const API_URL = 'http://127.0.0.1:8000/amr_api/data-views-instituto/';
    ...
    return (
        <Card className="shadow-sm">
            <Card.Header className="bg-dark text-white">
                <h5 className="mb-0">Instituto Superior Pedagogico - Monitoreo Energético</h5>
            </Card.Header>
            <Card.Body>
