...
const LaboratorioGraph = () => {
    ...
    const API_URL = 'http://127.0.0.1:8000/amr_api/data-views-laboratorio-tec/';
    ...
    return (
        <Card className="shadow-sm">
            <Card.Header className="bg-dark text-white">
                <h5 className="mb-0">Laboratorio Tec. Universidad - Monitoreo Energético</h5>
            </Card.Header>
            <Card.Body>
...
export default LaboratorioGraph;