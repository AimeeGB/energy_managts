...
const Add_Upgrade_Inspect = () => {
    
    const estadoinicial = { id: 0, tipo_inspeccion: "Empresa u Organismo Superior", nombre_inpectores: "", deficiencias_violaciones: "", plan_acciones: ""};
    ...
    const validationsForm = (inspecciones) => {
        ...
        if (!inspecciones.deficiencias_violaciones.trim()) {
            errors.deficiencias_violaciones = "¡¡¡Los deficiencias violaciones son Requeridos!!!";
        } else if (!regexDescripcion.test(inspecciones.deficiencias_violaciones.trim())) {
            errors.deficiencias_violaciones = "El campo deficiencias violaciones solo acepta 200.000 caracteres";
        }

        if (!inspecciones.plan_acciones.trim()) {
            errors.plan_acciones = "¡¡¡El plan acciones es Requerido!!!";
        } else if (!regexDescripcion.test(inspecciones.plan_acciones.trim())) {
            errors.plan_acciones = "El campo plan acciones solo acepta 200.000 caracteres";
        }
...
export default Add_Upgrade_Inspect